...
@section('content')
    <section class="cover-sec">
        <img src="{{url('/upload/user/'.$user->id.'/cover/'.$user->coverfoto)}}" alt="">
    </section>
                            ...
                            <div class="main-left-sidebar">
                                <div class="user_profile">
                                    <div class="user-pro-img">
                                        <img src="{{url('/upload/user/'.$user->id.'/foto/'.$user->foto)}}" alt="" width="150">
                                    ...
                                    <ul class="social_links" style="text-align:justify">
                                        <li>
                                            <span style="font-weight: bold;">{{$user->name}} - {{$user->username}}</span>
                                            <br>
                                            {{$user->description}}
                                        </li>
                                    </ul>
                                ...
                                <div class="suggestions full-width">
                                    ...
                                    <div class="suggestions-list">
                                        @foreach($user->followers->sortByDesc('id')->where('user_NIM','<>',Auth::user()->id)->take(4) as $follower)
                                        ...
                                        @endforeach 
                                        <div class="view-more">
                                            <a href="{{url('/viewallfollows/'.$user->nickname)}}" title="">View More</a>
                                        </div>
                            ...
                            <div class="main-ws-sec">
                                ...
                                <div class="product-feed-tab current" id="feed-dd">
                                    <div class="posts-section" id="status">
                                        @foreach($user->statuses->sortByDesc('id')->take(4) as $status)
                                        ...
                                        @if(!isset($thisstatus))
                                            <?php $thisstatus = 0; ?>
                                        @endif
                                        @if(App\Status::where('id','<',$thisstatus)->where('user_id',$user->id)->orderBy('created_at','desc')->count() > 0)
                                            <div class="process-comm" id="process-status">
                                                <a onclick="moreuserstatus()" stle="cursor:pointer" title=""><img src="{{url('images/process-icon.png')}}" alt=""></a>
                                ...
                                <?php $thisarticle = 0; ?>
                                    @foreach($user->articles->sortByDesc('id')->take('4') as $article)
                                    <div class="post-bar">
                                        <div class="post_topbar">
                                            <div class="usy-dt">
                                    ...
                                    @endforeach
                                    @if(App\Artikel::where('user_NIM',$user->id)->count()>0&&App\Artikel::where('user_NIM',$user->id)->first()->id<$article->id)
                        ...
                        <div class="col-lg-3">
                            <div class="right-sidebar">
                                <div class="message-btn">
                                    <a href="{{url('/viewmessage/'.$user->nickname)}}" title=""><i class="fa fa-envelope"></i> Message</a>
                                </div>
...
<script>
    $.ajaxSetup({
        ...
        function moreuserstatus() 
        {
            ...
            $.ajax({
                url: "{{url('/getuserstatus')}}/{{$user->id}}/"+status_id,
        ...
        function moreuserarticle() 
        {
            ...
            $.ajax({
                url: "{{url('/getuserarticle')}}/{{$user->id}}/"+article_id,
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    else if(data["data"]=="unfollow")
                    {
                        ...
                        $("#"+clicked_id).html('<i class="la la-minus"></i> Follow');
                    }
                }
            }); 
        }
