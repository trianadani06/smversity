                        ...
                        <div class="col-lg-6 col-md-8 no-pd">
                            <div class="main-ws-sec">
                                <div class="post-topbar">
                                    ...
                                    <div class="post-st">
                                        <ul>
                                            <li><a class="active" title="">All TimeLine</a></li>
                                            <li><a class="" href="{{url('/home')}}" title="">Friends TimeLine</a></li>
                                ...
                                <div class="posts-section" id="status">
                                    ...
                                    <?php $statuses =  App\Status::orderBy('id','desc')->paginate(4);?>
                                    ...
                                    @endforeach
                                    @if(App\Status::where('id','<',$stat_id)->count() > 0)
...
@section('js')
    <script>
        ...
        function moreallstatus() 
        {
            $( ".process-comm" ).remove();
            $.ajax({
                url: "{{url('/getallstatus')}}/"+status_id,
