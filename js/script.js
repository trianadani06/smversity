$(window).on("load", function() {
    ...
    $(".post-stat").on("click", function(){
        $(".post-popup.job_stat").addClass("active");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".post-project > a").on("click", function(){
        $(".post-popup.job_stat").removeClass("active");
        $(".wrapper").removeClass("overlay");
        return false;
    });
    ...
    $(".post-leader").on("click", function(){
        $(".post-popup.post-leader").addClass("active");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".post-project > a").on("click", function(){
        $(".post-popup.post-leader").removeClass("active");
        $(".wrapper").removeClass("overlay");
        return false;
    });
